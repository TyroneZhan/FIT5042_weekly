...
public class JPAPropertyRepositoryImpl implements PropertyRepository {
	...
	public List<ContactPerson> getAllContactPeople() {
		...
		//Traverse all the property in the propertyList and add person into the contactPersonList
		for(Property p : propertyList) {
	...
	public Set<Property> searchPropertyByContactPerson(ContactPerson contactPerson) {
		...
		//Please write your code here
		//Traverse all the property in the propertyList by contactPerson and add properties into the properSet
		for(Property p : propertyList) {
	...
	public List<Property> searchPropertyByBudget(double budget) {
		...
		//Traverse all the property in the propertyList by budget and add properties into the properSet
		for(Property p : propertyList) {
