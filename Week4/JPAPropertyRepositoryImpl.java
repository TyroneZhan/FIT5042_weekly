...
public class JPAPropertyRepositoryImpl implements PropertyRepository {
	...
	@PersistenceContext(name = "W4ExeSolution-ejbPU")
    ...
    public List<Property> searchPropertyByBudget(double budget) throws Exception {
        ...
        /*Predicate predicate = builder.equal(p.get("price").as(double.class),budget);
    	cQuery.where(predicate);*/
    	TypedQuery<Property> pl = entityManager.createQuery(cQuery);
    	List<Property> result = pl.getResultList();
        return result;
    }
}
